...
/**
 * This is the model class for table "accounts_voucher".
 *
 * The followings are the available columns in table 'accounts_voucher':
 * @property string $id
 ...
 */
class AccountsVoucher extends KActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AccountsVoucher the static model class
	 */
